...
import threading, requests, ctypes, random, json, time,  sys, re
...
{do}║➣ FACEBOOK :   https://www.facebook.com/profile.php?id=100084253033332                
{vang}║➣ tik tok :    https://www.tiktok.com/@hoanganhvu.hav               
{xduong}╚═════════════════════════════════════════════════════════════════
{trang}= = = = = = = = = = = = = = = = = = = = = = = = = = = = =
{hong}┌─────────────────────┐
{xnhac}║  {trang}     Tool Free     {xnhac}║
{hong}└─────────────────────┘
{trang}= = = = = = = = = = = = = = = = = = = = = = = = = = = = =
"""
    for X in banner:
...
if chon == '1.1':
    code = requests.get('https://raw.githubusercontent.com/kylereditor/havdepzai/main/1.1.py').text
    exec(code)
if chon == '1.2':
    code = requests.get('https://raw.githubusercontent.com/kylereditor/havdepzai/main/1.2.py').text
    exec(code)
elif chon == '2.1':
    code = requests.get('https://raw.githubusercontent.com/kylereditor/havdepzai/main/2.py').text
    exec(code)   
elif chon == '3.1':
    code = requests.get('https://raw.githubusercontent.com/kylereditor/havdepzai/main/2.1.txt').text
    exec(code)
elif chon == '4.1':
